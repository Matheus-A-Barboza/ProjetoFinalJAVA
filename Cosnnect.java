    ...
    public void sistema() {
        ...
        while(true){
            ...
            try {
                ...
                System.err.println("Usuario não cadastrado. Cadastre-se ou tente novamente!");
                continue;
            }
            ...
            try {
                ...
                System.err.println("Evento não existe. Tente novamente");
            }
            ...
            while(true){
                if(u.getNome_usuario() == null) {
                    System.out.println("Impossivel completar sua compra! Entre com sua conta e tente novamente");
                } break;
            }


            if (qnt_ingresso <= i.getQuantidade()) {
